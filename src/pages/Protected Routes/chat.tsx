...
function Chat() {
  ...
  try {
    validateIdSchema.parse({ id })
  } catch {
    return <ErrorPage msg='Please scan qr to acces the chat agent'/>
  }
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm checkout your supermarket assistant. How can I help you today?",
      sender: 'bot',
  ...
  const simulateServerResponse = async (userMessage, quickAction = null) => {
    ...
    // }
    console.log("Here", userMessage.text)
    const responseText = await Server.chatAgent(userMessage.text)
  ...
  return (
    <div className="flex flex-col h-screen bg-[gradient-to-br from-blue-50 to-indigo-100]">
      {/* Header */}
      <div className="bg-[#202121] shadow-lg border-b border-gray-200 p-4">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-[#292929] rounded-full flex items-center justify-center">
            <Bot className="w-6 h-6 text-white" />
          </div>
          <div>
            <h1 className="text-xl font-semibold text-white">Checkout</h1>
            <p className="text-sm text-white/50">Online • Always ready to help</p>
          </div>
        </div>
      </div>
              ...
              <div className="flex-1 px-2 py-2 flex flex-col justify-center">
                <div className="relative">
                  ...
                  <textarea
                    ...
                    placeholder={attachments.length > 0 ? "Add a message..." : "Start chat..."}
              ...
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span>
                  {attachments.length > 0 
                    ...
                    : <span>Press Enter to send<br />Shift+Enter for new line</span>
                  }
                </span>
